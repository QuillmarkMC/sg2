...
execute if items entity @s player.cursor phantom_membrane[minecraft:custom_data~{CreateTeam:true}] run function sg:lobby/teams/click_logic/create/get_data
execute if items entity @s player.cursor phantom_membrane[minecraft:custom_data~{JoinTeam:true}] run function sg:lobby/teams/click_logic/join/team/get_data
