...
item replace entity @s enderchest.11 with phantom_membrane[item_model="lobby:menu/gui/ready",custom_data={TeamSelect:true,Ready:true},lore=[{"translate": "sg.lobby.teams.item.ready.lore","color": "gray","italic": true}],custom_name={"translate":"sg.lobby.teams.item.ready.name","color": "dark_green","italic": false,"bold": true}]
