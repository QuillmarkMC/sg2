...
item replace entity @s enderchest.11 with phantom_membrane[item_model="lobby:menu/gui/ready",custom_data={TeamSelect:true,Ready:true}]
...
item replace entity @s enderchest.15 with phantom_membrane[item_model="lobby:menu/gui/spectate",custom_data={TeamSelect:true,Spectate:true}]
