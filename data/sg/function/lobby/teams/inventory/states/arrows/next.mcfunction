...
execute if score @s teamGUI.Page < $Num1 math run item replace entity @s enderchest.24 with phantom_membrane[item_model="lobby:menu/gui/arrow_right",custom_data={TeamSelect:true,Next:true},custom_name={"translate":"text.lobby.teams.item.navigation.next","color": "gray","italic": false,"bold": true}]
