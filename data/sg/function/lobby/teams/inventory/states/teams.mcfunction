...
item replace entity @s enderchest.22 with phantom_membrane[item_model="lobby:menu/gui/plus",custom_data={TeamSelect:true,NewTeam:true},lore=['{"translate": "text.lobby.teams.item.new.lore","color": "gray","italic": true}'],custom_name='{"translate":"text.lobby.teams.item.new.name","color": "green","italic": false,"bold": true}']
item replace entity @s enderchest.23 with phantom_membrane[item_model="lobby:menu/gui/spectate",custom_data={TeamSelect:true,Spectate:true},lore=['{"translate": "text.lobby.teams.item.spectator.lore","color": "gray","italic": true}'],custom_name='{"translate":"text.lobby.teams.item.spectator.name","color": "gray","italic": false,"bold": true}']
