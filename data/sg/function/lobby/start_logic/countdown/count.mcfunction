...
execute if score #Temp timers matches 1 unless score $Countdown timers matches 0..1 as @a at @s run playsound block.note_block.hat record @s ~ ~ ~ 1 0.6
execute if score #Temp timers matches 0 unless score $Countdown timers matches 0..1 as @a at @s run playsound block.note_block.hat record @s ~ ~ ~ 1 0.5
execute if score $Countdown timers matches 1 as @a at @s run playsound block.note_block.hat record @s ~ ~ ~ 1 0.8
