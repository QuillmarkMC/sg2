...
tellraw @a [{"translate":"text.lobby.start.cancel.prompt","color":"red","bold": true,"click_event": {"action":"run_command","command": "/trigger cancel"},"hover_event":{"action":"show_text","value":[{"translate":"text.lobby.start.cancel.hover","italic":true,"color":"gray"}]}}]
