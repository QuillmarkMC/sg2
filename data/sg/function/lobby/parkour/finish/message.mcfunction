...
tellraw @a [{"text":"[!] ","color":"dark_blue","bold": true},{"translate":"sg.lobby.parkour.complete","color": "white","bold": false,"with": [{"selector": "@s"},{"storage": "sg:parkour","nbt": "message.output","color": "green",interpret:true}]}]
