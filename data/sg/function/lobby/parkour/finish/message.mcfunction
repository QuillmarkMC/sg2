...
tellraw @a [{"text":"[!] ","color":"dark_blue","bold": true},{"translate":"text.lobby.parkour.complete","color": "white","bold": false,"with": [{"selector": "@s"},{"nbt": "message.output","storage": "sg:parkour"}]}]
