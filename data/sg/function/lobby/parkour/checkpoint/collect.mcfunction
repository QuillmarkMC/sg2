...
execute if score @s parkourCheckpoint matches 2..6 run tellraw @s [{"text":"[!] ","color":"dark_blue","bold": true},{"translate":"text.lobby.parkour.checkpoint","color": "white","bold": false}]
