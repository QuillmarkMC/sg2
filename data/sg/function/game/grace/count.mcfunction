...
execute if score $Countdown timers matches 60 as @a at @s run playsound block.anvil.place record @s ~ ~ ~ 0.75
...
execute if score $Countdown timers matches 31 as @a at @s run playsound block.anvil.place record @s ~ ~ ~ 0.75
...
execute if score $Countdown timers matches 15 as @a at @s run playsound block.anvil.place record @s ~ ~ ~ 0.75
